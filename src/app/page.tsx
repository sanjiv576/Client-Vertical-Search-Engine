      ...
      <div className="w-full max-w-4xl flex flex-col items-center space-y-12 mb-32">
        ...
        <div className="relative">
          ...
          <h1 className="relative text-5xl md:text-7xl font-extrabold text-center tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-500 drop-shadow-lg p-2 leading-tight">
            ...
            <span className="text-3xl md:text-5xl opacity-90">Vertical Search Engine</span>
          </h1>
        </div>
        ...
        <form onSubmit={handleSearch} className="w-full max-w-2xl relative group">
          ...
          <div className="relative">
            ...
            <input
              type="text"
              autoFocus
              className="w-full pl-16 pr-8 py-5 rounded-full bg-slate-900/90 border border-slate-700/50 focus:border-cyan-500/50 focus:bg-slate-900 focus:ring-4 focus:ring-cyan-500/20 text-xl text-slate-100 placeholder-slate-500 outline-none transition-all duration-300 shadow-xl backdrop-blur-md"
